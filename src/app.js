...
// Genera una carta nueva
function generateNewCard() {
  let randomValue = Math.floor(Math.random() * cardValues.length);
  ...
  // Resetear clases y aplicar la del palo
  card.className = 'card';
  card.classList.add(suit.name);

  // Asignar valores y símbolos
...
// Alterna el temporizador automático
